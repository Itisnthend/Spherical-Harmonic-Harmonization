function FOD_AdaptiveConvexOpt_WholeVolume_KernelOptimization(GradTable,BValLowTHD,BValHighTHD,Data,GradDev,Mask,SPHMaxOrder,MinNumConstraint, NumOptiSteps,init_xi,xi_stepsize,xi_NumSteps,MaxNumFiberCrossingPerVoxel,UniformityFlag,NoiseFloor, SPH_Coef_Nifti, TissueMap_Nifti)
...
if ispc
    load ConstraintSet.mat
else
    load('/ifs/loni/faculty/shi/spectrum/yshi/FOD/Code/ConstraintSet.mat');
end
...
if ispc
    params.object = 'sphere5120.obj';
else
    params.object = '/ifs/loni/faculty/shi/spectrum/yshi/FOD/Code/sphere5120.obj';
end
